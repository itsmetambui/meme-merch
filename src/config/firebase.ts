...
const addCollectionAndDocuments = async (collectionKey: string, objectsToAdd: any) => {
...
export { auth, firestore, signInWithGoogle, createUserProfileDocument, addCollectionAndDocuments }
